package com.podoseee.model.service;
...
/*
    ...
    1. 비즈니스 로직 처리와 트랜잭션 관리를 담당
       ...
       - 사용자인터페이스(UI)와 데이터베이스(Model) 사이의 계층
    2. 처리 과정
       1) Connection 생성
       2) 순차적으로 작업 실행
...
import com.podoseee.model.dao.MenuDAO;
import com.podoseee.model.dto.CategoryDTO;
import com.podoseee.model.dto.MenuDTO;
...
public class MenuService {
    ...
    public int registCategoryAndMenu2(CategoryDTO category,MenuDTO menu){
        ...
        int result = 0; // 해당 작업들 전체의 성공여부를 판변할 면수 (최종결과)
