package com.jjanggu.menu.controller;

import com.jjanggu.menu.model.dto.CategoryDto;
import com.jjanggu.menu.model.dto.MenuDto;
import com.jjanggu.menu.model.service.MenuService;
import com.jjanggu.menu.view.PrintResultView;
...
public class MenuController {
    ...
    public void modifyMenu(Map<String, String> requestParam){
        ...
        menu.setMenuName( requestParam.get("name") );
        menu.setMenuPrice( Integer.parseInt(requestParam.get("price")) );
        menu.setCategory( requestParam.get("categery") );
